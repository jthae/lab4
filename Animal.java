...
public class Animal
{
    ...
    public boolean equals(Object other)
    {
        ...
        boolean sameColor = otherAni.getColor().equals(this.getColor());
        boolean sameName = otherAni.getName().equals(this.getColor());
        boolean sameWeight = otherAni.getWeight() == this.getWeight();
        boolean sameHeight = otherAni.getHeight() == this.getHeight();
